...
public class SimpleProducer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // buffer.memory controle le montant total de memoire disponible au producteur pour le
        // buffering
        ...
        WeatherProducer<String, String> producer = new KafkaProducer<String, String>(props);
